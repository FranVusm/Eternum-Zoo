...
public class Vida_NPC : MonoBehaviour
{
    ...
    public float velocidad = 0f; // Velocidad a la que nos moveremos hacia el jugador
    public float distanciaAcercarMaxima = 0f;
    public float distanciaAcercarMínima = 0f;
